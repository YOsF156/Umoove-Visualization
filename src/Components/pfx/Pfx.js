  ...
  return (
    <>
      {!start && (
        <div>
          <h1>Umoove log</h1>
          <input type="file" accept=".csv" onInput={(e) => handleFileSelect(e, "umoove")} />
          {/* <input type="file" id="selectedFile" style={{display: 'none'}}  onInput={(e) => handleFileSelect(e, "umoove")} /> */}
      ...
      {!start && (
        <div>
          <h1>Feedback (state) log</h1>
          <input type="file" accept=".csv" onInput={(e) => handleFileSelect(e, "state")} />
        </div>
      )}
      {!start && csvData && (
